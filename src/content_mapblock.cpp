	...
	for(s16 x=0; x<MAP_BLOCKSIZE; x++)
	{
		...
		case NDT_FLOWINGLIQUID:
		{
			...
			*/
			...
			content_t c_flowing = nodedef->getId(nodedef->get(n).liquid_alternative_flowing);  // FIXME NDEF_GETID
			content_t c_source = nodedef->getId(nodedef->get(n).liquid_alternative_source); // FIXME NDEF_GETID
