...
minetest.register_node("default:fence_wood", {
	...
	selection_box = {
		type = "fixed",
		fixed = {{-1/7, -1/2+1/100, -1/7, 1/7, 1/2-1/100, 1/7}},
	},
	furnace_burntime = 15,
	material = minetest.digprop_woodlike(0.75),
})
...
minetest.register_node("default:rail", {
	...
	selection_box = {
		type = "fixed",
		fixed = {{-1/2+1/100, -1/2+1/100, -1/2+1/100, 1/2-1/100, -1/2+1/16-1/100., 1/2-1/100}},
	},
...
minetest.register_node("default:torch", {
	...
	selection_box = {
		type = "wallmounted",
		wall_top = {-0.1, 0.5-0.6, -0.1, 0.1, 0.5-0.01, 0.1},
		wall_bottom = {-0.1, -0.5+0.01, -0.1, 0.1, -0.5+0.6, 0.1},
		wall_side = {-0.5+0.01, -0.3, -0.1, -0.5+0.3, 0.3, 0.1},
	},
